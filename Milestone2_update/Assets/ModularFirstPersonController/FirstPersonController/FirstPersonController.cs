...
public class FirstPersonController : MonoBehaviour
{
    ...
    public GameObject weaponPlacementLocation;
    ...
    {
        GameObject weaponPref = Instantiate(defaultWeapon,Vector3.zero, Quaternion.identity);
        weaponPref.transform.SetParent(weaponPlacementLocation.transform, false);
        weapon = weaponPref.GetComponent<Weapon>();
    }
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        GUILayout.Label("Weapon Setup", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
        fpc.weaponPlacementLocation = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Weapon Tranform", "game object To attach weapon"), fpc.weaponPlacementLocation, typeof(GameObject), true);
        fpc.defaultWeapon = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Default Weapon", "default Weapon to attach at transform location if any"), fpc.defaultWeapon, typeof(GameObject), true);
